			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					if ($user['role'] == 'Admin') { ?>
						...
						<li class="active">
							<a href="<?= site_url('Prodi/prodi/') ?>">
								<i class="nc-icon nc-pin-3"></i>
								<p>Prodi</p>
							</a>
						</li>
						<li class="active">
							<a href="<?= site_url('Calpres/calpres/') ?>">
								<i class="nc-icon nc-single-02"></i>
								<p>Calon Presiden</p>
							</a>
						</li>
						<li class="active">
							<a href="<?= site_url('Formd/formd') ?>">
						...
						<ul class="navbar-nav">
							<li class="nav-item dropdown no-arrow">
								<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true">
									...
									<img class="img-profile rounded-circle" src="<?= base_url('assets/assets/img/profile/') . $user['gambar']; ?> ">
								</a>
